...
5.53        T_G1_1                                G1 phase base time (h)
7.69        T_S_1                                 S phase base time (h)
4.98        T_G2_1                                G2 phase base time (h)
...
-1			PHASE_HOURS							  Time of recording phase distribution
0.000739    BASERATE                              Base apoptosis rate parameter
0.0141      MITRATE                               Mitosis rate parameter
0.04        MSURVIVAL                             Survival probability factor for IR in mitosis
2.3         KLETHAL                               MisrepRate scaling factor
0.076       KATM_1                                K_ATM(1) parameter
0.3         KATM_2                                K_ATM(2) parameter
$ katm3          $         KATM_3                                K_ATM(3) parameter
$ katm4          $         KATM_4                                K_ATM(4) parameter
0.005       KATR_1                                K_ATR(1) parameter
0.3         KATR_2                                K_ATR(2) parameter
$ katr3          $         KATR_3                                K_ATR(3) parameter
$ katr4          $         KATR_4                                K_ATR(4) parameter
0.65        PCOMPLEX                              PCOMPLEX parameter
