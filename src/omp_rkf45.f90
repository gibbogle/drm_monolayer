  ...
  if ( mflag /= 1 ) then
    ...
    if ( mflag == 2 ) then
      ...
      if ( kflag == 3 ) then
        ...
        write(*,*) 'ERROR: r4_rkf45: kflag=5, abserr = 0'
        stop
        ...
        write(*,*) 'ERROR: r4_rkf45: kflag=6, relerr,abserr too small'
        stop
...
!
        ...
        write(*,*) 'ERROR: r4_rkf45: bad flag: ',flag
        stop
      end if
...
!
!Gib doesn't see the point of this check
!Gib  if ( 2.0E+00 * abs ( dt ) <= abs ( h ) ) then
!Gib    kop = kop + 1
!Gib  end if
!
...
!
!Gib    hmin = 26.0E+00 * eps * abs ( t )   ! try changing this - seems crazy
    hmin = 26.0E+00 * eps * abs ( dt )
!
...
!      write(*,*) 'r4_rkf: gib: esttol: ',esttol,h,eeoet,scale
  ...
  if ( mflag /= 1 ) then
    ...
    if ( mflag == 2 ) then
      ...
      if ( kflag == 3 ) then
        ...
        write(*,*) 'ERROR: r8_rkf45: kflag=5, abserr = 0'
        stop
...
!
        ...
        write(*,*) 'ERROR: r8_rkf45: bad flag: ',flag
        stop
      end if
