...
-2			PHASE_HOURS							  Time of recording phase distribution
0.0008        BASERATE                              Base apoptosis rate parameter
0.013       MITRATE                               Mitosis rate parameter
0.04        MSURVIVAL                             Survival probability factor for IR in mitosis
2.33        KLETHAL                               MisrepRate scaling factor
$ katm2          $       KATM_2                                K_ATM(2) parameter
$ katm3          $         KATM_3                                K_ATM(3) parameter
1.0         KATM_4                                K_ATM(4) parameter
$ katr2          $       KATR_2                                K_ATR(2) parameter
0.3         KATR_3                                K_ATR(3) parameter
$ katr4          $         KATR_4                                K_ATR(4) parameter
0.68        PCOMPLEX                              PCOMPLEX parameter
